...
const PROFILES_RAW = [
  ...
  {
    enabled:true,
    meta:{id:'program-output-source-flow',name:'Source Program Output',
      description:'Trace output inside the complete authored C or Java source file, including contextual lines.'},
    shape:{operandSources:{variable:3},operandRange:{min:2,max:12},allowNegativeOperands:false},
    operators:{allowed:OPS.ADD_SUB},
    template:'operand op operand op operand',
    scoring:{itemCount:'manifest',pointsPerItem:2},
    content:{provider:'program-output',mode:'source-files',recipe:'formatted-values',
      exerciseSet:'formatted-output',presentation:'source-flow',selection:{count:'all',shuffle:false}},
    program:{declarations:'interactive',outputLesson:'formatted-values',scoreAssignments:true},
  },
  {
    enabled:true,
    meta:{id:'selection-statements-source',name:'Selection Statements',
      description:'Evaluate conditions and trace the selected path through complete C or Java source code.'},
    ...
    scoring:{itemCount:'manifest',pointsPerItem:2},
    content:{provider:'program-selection',mode:'source-files',exerciseSet:'selection-basics',sourceValueMode:'seeded',
